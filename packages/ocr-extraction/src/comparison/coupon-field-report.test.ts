...
const docsPath = path.join(packageRoot, "docs", "ocr-rule-guide-coupon.md");
const ocrDir = path.join(packageRoot, "fixtures", "ocr");
const reportPath = path.join(packageRoot, "artifacts", "json", "coupon-field-extraction-report.json");
